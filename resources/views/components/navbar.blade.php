<nav class="bg-white w-100 fixed-top overflow-hidden shadow-sm">
    <div class="row justify-content-center">
        <div class="col-10 col-md-11">
            <div class="d-flex w-100 justify-content-between align-items-center overflow-hidden">
                ...
                <button class="hamburger-menu d-flex d-md-none" id="hamburgerButton" type="button">
                    <div></div>
                    <div></div>
                    <div></div>
                </button>
