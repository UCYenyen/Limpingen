<div class="d-flex p-4 justify-content-between flex-column align-items-center align-items-sm-start gap-4 bg-white shadow-lg rounded-lg services-card" style="max-width: 400px">
