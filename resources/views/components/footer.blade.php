<footer class="w-100 mt-24 d-flex flex-column justify-content-between align-items-center bg-mid-blue text-white">
    ...
    <div class="d-flex w-100 flex-column flex-lg-row justify-content-between align-items-center align-items-lg-start p-8 gap-8" style="width: 90%">
        <div class="d-flex flex-column justify-content-center align-items-center align-items-lg-start gap-4">
            ...
            <div class="d-flex gap-4">
                <p class="fs-6 fw-normal mb-0">FB</p>
                <p class="fs-6 fw-normal mb-0">EM</p>
                <p class="fs-6 fw-normal mb-0">WA</p>
            </div>
        </div>
        <div class="d-flex flex-column flex-lg-row gap-8 align-items-center align-items-lg-start">
            <div class="d-flex flex-column gap-4 align-items-center align-items-lg-start">
                <h2 class="fs-2 fw-bold">Contact us</h2>
    ...
    <div class="bg-dark-blue w-100">
        <p class="fs-6 fw-normal py-4 text-center m-0">© 2024 Limpingen. All rights reserved.</p>
    </div>
</footer>
